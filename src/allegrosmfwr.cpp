...
class Alg_smf_write {
public:
    Alg_smf_write(Alg_seq *s, std::ostream &file) : out_file{file}, seq{s} {};
...
{
    Alg_smf_write writer(this, file);
    writer.write();
}
